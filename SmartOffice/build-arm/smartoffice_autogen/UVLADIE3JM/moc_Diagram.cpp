...
static constexpr auto qt_meta_stringdata_ZN7DiagramE = QtMocHelpers::stringData(
    "Diagram"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7DiagramE[] = {
...
Q_CONSTINIT const QMetaObject Diagram::staticMetaObject = { {
    QMetaObject::SuperData::link<QskControl::staticMetaObject>(),
    qt_meta_stringdata_ZN7DiagramE.offsetsAndSizes,
    qt_meta_data_ZN7DiagramE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7DiagramE_t,
        // Q_OBJECT / Q_GADGET
...
void *Diagram::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7DiagramE.stringdata0))
        return static_cast<void*>(this);
    return QskControl::qt_metacast(_clname);
}

int Diagram::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QskControl::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
